kiemtra = () => {
    const ht = window.document.dangky.txthoten.value;
    const na = window.document.dangky.nam.value;
    const email = window.document.dangky.em.value;
    const tdn = window.document.dangky.tdn.value;
    const mk = window.document.dangky.mk.value;
    const nlmk = window.document.dangky.nlmk.value
    if (ht.length === 0) {
